  ...
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      <Canvas camera={{ position: [0, 0, 4], fov: 50 }} gl={{ alpha: true, antialias: true }}>
        <ShaderPlane position={[-1.2, 0.9, -0.5]} color1="#ff6a3d" color2="#f8fafc" />
        <ShaderPlane position={[1.35, -0.65, -0.2]} color1="#22d3ee" color2="#f97316" />
        <ShaderPlane position={[0.2, 0.15, -0.8]} color1="#ffffff" color2="#1e293b" />
        <EnergyRing radius={0.72} position={[-1.45, 0.95, 0]} />
        <EnergyRing radius={0.58} position={[1.3, -0.8, 0]} />
      </Canvas>
    </div>
  );
}
