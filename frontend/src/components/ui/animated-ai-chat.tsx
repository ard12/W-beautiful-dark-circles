      ...
      <div className="relative mx-auto w-full max-w-2xl">
        ...
        >
            ...
            <div className="p-4">
              <Textarea
                ...
                className={cn(
                  ...
                  "text-sm text-white/90 focus:outline-none placeholder:text-white/20",
                )}
                style={{
                  overflow: "hidden",
                }}
            ...
            <div className="flex items-center justify-between gap-4 border-t border-white/[0.05] p-4">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <motion.span className="absolute inset-0 rounded-lg bg-white/[0.05] opacity-0 transition-opacity group-hover:opacity-100" layoutId="button-highlight" />
                </motion.button>
                <motion.button
                  type="button"
                  data-command-button
          ...
          <AnimatePresence>
            {recentCommand ? (
              <motion.div
                className="mx-auto flex w-fit items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-400/8 px-4 py-2 text-xs uppercase tracking-[0.24em] text-cyan-200"
                initial={{ opacity: 0, y: 8 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: 8 }}
              >
                <Sparkles className="h-3.5 w-3.5" />
                {recentCommand} queued
              </motion.div>
            ) : null}
          </AnimatePresence>
        </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-7 w-8 items-center justify-center rounded-full bg-white/[0.05] text-center">
                <span className="mb-0.5 text-xs font-medium text-white/90">ai</span>
              </div>
